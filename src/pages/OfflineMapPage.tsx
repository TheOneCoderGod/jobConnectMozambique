        ...
        <Paper sx={{ p: 3, mb: 3 }}>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
            <Typography variant="h6">
              {isOfflineMode ? (
                <><CloudOffIcon sx={{ mr: 1 }} /> Offline Mode</>
              ) : (
                <><MapIcon sx={{ mr: 1 }} /> Online Mode</>
              )}
            </Typography>
            <FormControlLabel
              control={
        ...
        <Paper sx={{ p: 3, mt: 3 }}>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
            ...
            <Typography variant="body2" paragraph>
              When you have internet, click "Save for Offline Use" to store the map data on your device. This allows you to view the map even when you don't have internet.
            </Typography>
            ...
            <Typography variant="body2" paragraph>
              Click on a location in the list or on the map to see job opportunities in that area. Popular locations have more job opportunities.
            </Typography>
            ...
            <Typography variant="body2" paragraph>
              Click on a job marker on the map to see details about that job opportunity. You can see the payment, employer, and contact information.
            </Typography>
            ...
            <Typography variant="body2">
              When you find a job you're interested in, you can call the employer directly from the app. The phone number works even when you're offline.
            </Typography>
          </Box>
